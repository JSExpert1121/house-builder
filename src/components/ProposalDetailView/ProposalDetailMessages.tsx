...
const mapDispatchToProps = dispatch => {
  return {
    getProposalMessages: (id, page, size, cb) =>
      dispatch(getProposalMessages(id, page, size, cb)),
    addMessageToProposal: (prop_id, message, cb, cont_type) =>
      dispatch(addMessageToProposal(prop_id, message, cb, cont_type)),
    addFileToPropMessage: (msg_id, files, cb) =>
      dispatch(addFileToPropMessage(msg_id, files, cb)),
  };
};
